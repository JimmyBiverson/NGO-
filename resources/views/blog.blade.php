...
@section('content')
    ...
    <section class="relative pt-32 pb-20 lg:pt-40 lg:pb-24 bg-forest-900 overflow-hidden">
        ...
        <div class="absolute inset-0 z-[1] bg-cover bg-center opacity-20" style="background-image: url('https://images.unsplash.com/photo-1499750310107-5fef28a66643?w=1920&q=85&fm=webp');"></div>
                    ...
                    @php
                        $posts = [
                            ...
                            [
                                ...
                                'image' => 'https://images.unsplash.com/photo-1531123897727-8f129e1688ce?w=800&q=85&fm=webp',
                                'category' => 'Education',
                            ],
                            [
                                ...
                                <div class="p-6">
                                    ...
                                    <p class="text-sm text-gray-600 leading-relaxed mb-4">{{ $post['excerpt'] }}</p>
                                        {{-- Placeholder: replace '#' with post URL when dynamic routing is added --}}
                                         <a href="#" class="inline-flex items-center gap-1 text-sm font-semibold text-amber-700 hover:text-amber-800 transition-colors break-words">
